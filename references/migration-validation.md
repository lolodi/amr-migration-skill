...
> **Note**: VNet-injected source caches are supported by the automated migration API. Ensure Private Endpoints are configured on the target AMR cache before migrating to maintain network isolation.
